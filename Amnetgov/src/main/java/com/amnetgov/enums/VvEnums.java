...
public enum VvEnums {
	VERIFICATION_OK(1),VERIFICATION_FAILED(-1), DISABLED(0), ACTIVE(1), DELETED(2), START_SPECIALIST_TEST(1), END_SPECIALIST_TEST(
			0), NOT_UPDATED(0), UPDATED(1), SECRETARY_SESSION(0), CERTIFICATORY_SESSION(3), PROCESS_SESSION(
					2), RESPONSE_OK(1), RESPONSE_BAD(1), COMBO(2), BIKE_ONLY(1), APTO(1), NO_APTO(
