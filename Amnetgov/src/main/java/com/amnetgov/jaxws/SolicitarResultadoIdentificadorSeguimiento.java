...
@XmlRootElement(name = "SolicitarResultadoIdentificadorSeguimiento", namespace = "http://amnetgov.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "SolicitarResultadoIdentificadorSeguimiento", namespace = "http://amnetgov.com/", propOrder = {"UsuarioServicio", "ContrasenaServicio", "IdSeguimiento"})
