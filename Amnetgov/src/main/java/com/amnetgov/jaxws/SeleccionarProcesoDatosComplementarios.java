...
@XmlRootElement(name = "SeleccionarProcesoDatosComplementarios", namespace = "http://amnetgov.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "SeleccionarProcesoDatosComplementarios", namespace = "http://amnetgov.com/", propOrder = {"UsuarioServicio", "ContrasenaServicio", "IdProceso"})
