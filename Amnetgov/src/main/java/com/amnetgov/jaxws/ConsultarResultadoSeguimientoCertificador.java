...
@XmlRootElement(name = "ConsultarResultadoSeguimientoCertificador", namespace = "http://amnetgov.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ConsultarResultadoSeguimientoCertificador", namespace = "http://amnetgov.com/", propOrder = {"UsuarioServicio", "ContrasenaServicio", "IdSeguimiento"})
