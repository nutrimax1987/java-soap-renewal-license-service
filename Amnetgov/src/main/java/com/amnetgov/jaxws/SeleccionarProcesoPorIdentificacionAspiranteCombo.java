...
@XmlRootElement(name = "SeleccionarProcesoPorIdentificacionAspiranteCombo", namespace = "http://amnetgov.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "SeleccionarProcesoPorIdentificacionAspiranteCombo", namespace = "http://amnetgov.com/", propOrder = {"UsuarioServicio", "ContrasenaServicio", "TipoIdentificacion", "NumeroIdentificacion"})
